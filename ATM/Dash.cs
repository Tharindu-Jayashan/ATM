...
namespace ATM
{
    ...
    {
        public static string AccNo , EReceipt_enabled;
        ...
        public Dash1()
        {
            ...
            cnn = new SqlConnection(connectionString);
            cnn.Open();
            string sql = "Select Status from EReceipt where AccNo = '" + Dash1.AccNo + "'";
            ...
            using (SqlDataReader reader = cmd.ExecuteReader())
            {
                while (reader.Read())
                {
                    EReceipt_enabled = Convert.ToString(reader["Status"]);
                }
            }
            cnn.Close();
        }
